    ...
    methods
        ...
        function dgate = bpropGate(obj, d)
            ...
            for t=obj.T:-1:1
                ...
                dz(:,:,t) = dh .* (-obj.states{7}(:,:,t) + obj.states{6}(:,:,t)) .* obj.dsigmoid(obj.states{1}(:,:,t));
                dr(:,:,t) = du(:,:,t) .* (obj.prms{6}*obj.states{7}(:,:,t)) .* obj.dsigmoid(obj.states{3}(:,:,t));
                
                gradR_z = gradR_z + dz(:,:,t)*obj.states{7}(:,:,t)';
                gradR_r = gradR_r + dr(:,:,t)*obj.states{7}(:,:,t)';
                gradR_u = gradR_u + (du(:,:,t).*obj.states{4}(:,:,t))*obj.states{7}(:,:,t)';
            end
